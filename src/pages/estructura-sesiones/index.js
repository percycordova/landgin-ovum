...
const EstructuraSesiones = (props) => {
  const { Estructura } = props;
  const { sesiones, titulo } = Estructura;
  ...
  return (
    <div className="">
      <Head>
        <title>OVUM 2022 - ESTRUCTURA SESIONES</title>
        <meta
          name="description"
        ...
        <div className="mt-11">
          <div className="lg:w-256 max-w-7xl mx-auto px-4 lg:px-0 pb-52">
            ...
            <div className="flex items-center gap-3 mb-9">
              <div className="w-18 h-20  bg-green-500 rounded-2xl">
                <img src="/pollo.png" className="w-14 mx-auto h-20" alt="" />
              </div>
            ...
            <div className=" flex flex-col-reverse gap-5 lg:flex-row lg:items-center">
              <p className="text-sm font-light">
                Transmitidas presencial e interactivamente, permitirán encontrar
                soluciones conjuntas a los principales retos de nuestra
                industria. <br />
            ...
            <div className="mt-14">
              ...
              <div className="mb-8">
                <h6 className="text-sm mb-4 font-semibold">
                  Dár encontrar soluciones conjuntas a los principales retos de nuestra industria.
                </h6>
                <p className="text-sm font-light">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
export default EstructuraSesiones;
