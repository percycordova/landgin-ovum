...
const EstructuraSalas = (props) => {
  const { Estructura } = props;
  const { salas, titulo } = Estructura;
  ...
  return (
    <div className="">
      <Head>
        <title>OVUM 2022 - ESTRUCTURA SALAS</title>
        <meta
          name="description"
        ...
        <div className="mt-11">
          <div className="lg:w-256 max-w-7xl mx-auto px-4 lg:px-0 pb-52">
            ...
            <div className="flex items-center gap-3 mb-9">
              <div className="w-18 h-20 bg-yellow-800 rounded-2xl">
                <img src="/pollo-black.png" className="w-14 mx-auto h-18 object-cover " alt="" />
              </div>
            ...
            <div className=" flex flex-col-reverse gap-5 lg:flex-row lg:items-center">
              <p className="text-sm font-light">
                Acondicionadas especialmente para dar confort a todos los
                participantes, considerando las medidas de bioseguridad que
                rigen a nivel internacional.<br />
...
export default EstructuraSalas;
