...
const EstructuraTurismo = (props) => {
  const { Estructura } = props;
  const { turismo, titulo } = Estructura;
  ...
  return (
    <div className="">
      <Head>
        <title>OVUM 2022 - ESTRUCTURA TURISMO</title>
        <meta
          name="description"
      ...
      <main className="">
        ...
        <div className="mt-11">
          <div className="lg:w-256 max-w-7xl mx-auto px-4 lg:px-0 pb-52">
            ...
            <div className="flex items-center gap-3 mb-9 overflow-hidden">
              <div className="w-18 h-20 bg-yellow-300 rounded-2xl">
                <img
                  src="/ala-black.png"
                  className="w-14 mx-auto h-20 
                "
                  alt=""
                />
              </div>
            ...
            <div className=" flex flex-col-reverse gap-5 lg:flex-row lg:items-center">
              <p className="text-sm font-light">
                El caribe hondureño y la majestuosa cultura ancestral de la
                Ciudad de los Zorzales espera a todos los actores de nuestra
                industria avícola, para dar el marco apropiado en San Pedro
                Sula. ¡El OVUM 2022! <br />
...
export default EstructuraTurismo;
