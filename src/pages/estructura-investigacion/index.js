...
const EstructuraInvestigacion = (props) => {
  const { Estructura } = props;
  const { investigacion, titulo } = Estructura;
  ...
  return (
    <div className="">
      <Head>
        <title>OVUM 2022 - ESTRUCTURA INVESTIGACION</title>
        <meta
          name="description"
        ...
        <div className="mt-11">
          <div className="lg:w-256 max-w-7xl mx-auto px-4 lg:px-0 pb-52">
            ...
            <div className="flex items-center gap-3 mb-9">
              <div className="w-18 h-20 bg-blue-500 rounded-2xl">
            ...
            <div className=" flex flex-col-reverse gap-5 lg:flex-row lg:items-center">
              <p className="text-sm font-light">
                Los principales actores de la ciencia, marcarán una tendencia de
                gran impacto a los desafíos de la avicultura. <br />
              ...
              <img
                src="estructura__investigacion.png"
                alt=""
...
export default EstructuraInvestigacion;
