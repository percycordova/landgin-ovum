...
const EstructuraExpoferia = (props) => {
  const { Estructura } = props;
  const { expoferia, titulo } = Estructura;
  ...
  return (
    <div className="">
      <Head>
        <title>OVUM 2022 - ESTRUCTURA EXPOFERIA</title>
        <meta
          name="description"
        ...
        <div className="mt-11">
          <div className="lg:w-256 max-w-7xl mx-auto px-4 lg:px-0 pb-52">
            ...
            <div className="flex items-center gap-3 mb-9">
              <div className="w-18 h-20  bg-green-400 rounded-2xl">
                <img src="/gallina.png" className="w-14 mx-auto h-20" alt="" />
              </div>
            ...
            <div className=" flex flex-col-reverse gap-5 lg:flex-row lg:items-center">
              <p className="text-sm font-light">
                La participación de todos los que conforman la cadena de valor
                de la avicultura latinoamericana, startups, trabajos de
                investigación y lo más novedoso en tecnología para nuestra
                avicultura. <br />
...
export default EstructuraExpoferia;
