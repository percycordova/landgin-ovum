  ...
  return (
    ...
    <div className="  relative z-10 py-2 text-white" >
      ...
      <div className="relative h-80">
        <p className="font-bold text-2.5xl md:text-5xl  z-20 relative mt-30 text-center banner__fecha">
          {idiomas.Banner.value}
        </p>
        <p className="text-center z-20 text-base md:text-4xl relative  banner__san-pedro">
          San Pedro Sula, Honduras
        </p>
        <div className="flex justify-center relative z-20 mt-6 lg:mt-30 w-64 mx-auto ">
          <a
