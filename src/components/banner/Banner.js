...
const Banner = () => {
  return (
    <div className=" banner relative z-10 py-9 text-white">
      {/* version mobil */}
      <img src="/grupo-rayas2-mobil.svg" alt="" className="absolute top-0 right-0 opacity-40  md:hidden" />
      {/* desktop */}
      <img src="/grupo-rayas2.svg" alt="" className="hidden md:block absolute top-0 right-0 opacity-20 " />
      <Idiomas />
      <div className="logo md:flex-row flex flex-col md:justify-center mt-3 relative">
        <img src="/logo.svg" className="z-20 relative w-140  hidden md:block" />
        <img src="/logo-mobil.svg" className="z-20 relative  md:hidden  h-72" />
        <div className="banner__cards md:absolute md:bottom-0  flex gap-x-2 md:gap-x-6  justify-center">
      ...
      {/* version mobil */}
      <img src="/grupo-rayas-mobil.svg" alt="" className="absolute -bottom-5 left-0  md:hidden opacity-40" />
      {/* desktop */}
      <img src="/grupo-rayas.svg" alt="" className="hidden md:block absolute -bottom-44 left-0 opacity-20 " />
    </div>
  )
}
